...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PosterRoommatesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.RoommateFormDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateRoommateFormRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/me/roommate-matches/incoming": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/user.GetIncomingRoommateMatchesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/user/me/roommate-matches/matched": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/user.GetMatchedRoommateMatchesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/user.GetRoommateUserResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/user.GetRoommateContactsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.PosterRoommatesResponse": {
            ...
            "properties": {
                ...
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.RoommateUserDTO"
                    }
                }
            }
        },
        ...
        "user.GetIncomingRoommateMatchesResponse": {
            ...
            "properties": {
                ...
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/user.RoommateUser"
                    }
                }
            }
        },
        "user.GetMatchedRoommateMatchesResponse": {
            "type": "object",
            "properties": {
                "len": {
                    "type": "integer"
        ...
        "user.GetRoommateContactsResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "user.GetRoommateUserResponse": {
            ...
            "properties": {
                ...
                "tags": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/user.RoommateTag"
                    }
                }
            }
        },
